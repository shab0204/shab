// const rootElem2 = document.getElementById('root2')
// const btn = document.createElement('button')
// btn.textContent = 'ghbdt'
// rootElem2.appendChild(btn)
...
//       }
// ]
// function generatePostsWPhoto(arrPostPhoto){
// rootElem2.innerHTML = ''
// arrPostPhoto.forEach(element => {
//     const album = document.createElement('div')
//     album.className = (`album`)
//     album.style = (`display:flex;flex-direction:column;`)
//     switch (element.albumId) {
//         case 1:
//             album.style.backgroundColor = 'red';
...
//             break;
//         case 3:
//             album.style.backgroundColor = 'green';
//             album.style.color = 'white';
//             break;
//         default:
//             album.style.backgroundColor = 'gray';
//             album.style.color = 'white';
//             break;
//     }

//     const album_id = document.createElement('p')
//     album_id.className = (`album_id`)
    // album_id.textContent = (`id: ${element.id}`)
//     album_id.style = (`padding:20px`)

//     const album_title = document.createElement('h1')
//     album_title.className = (`album_title`)
//     album_title.textContent = element.title
//     album_title.style = (`padding:20px`)

//     const album_url = document.createElement(`img`)
//     album_url.className = (`album_url`)
//     album_url.src = element.url
//     album_url.style = (`padding:20px`)

//     const thumbnailUrl = document.createElement(`img`)
//     thumbnailUrl.className = (`thumbnailUrl`)
//     thumbnailUrl.src = element.thumbnailUrl
//     thumbnailUrl.style = (`padding:20px`)

//     album.appendChild(album_id)
//     album.appendChild(album_title)
//     album.appendChild(album_url)
//     album.appendChild(thumbnailUrl)

//     rootElem2.appendChild(album)
// });
// }
// generatePostsWPhoto(albums)
